...
const Testimonial5 = () => {
  return (
    <div className="flex text-white flex-col lg:flex-row py-10 gap-6 justify-center items-center w-full min-h-[600px] rounded-md border bg-gradient-to-r from-gray-700 via-gray-900 to-black">
      <div className="flex gap-10 flex-col p-10">
        ...
        <div className="flex gap-2 items-center">
          ...
          <div className="flex flex-col gap-2">
            <h4 className="text-sm lg:text-md font-bold">Helga Black</h4>
            <h4 className="text-sm lg:text-md">CEO & Founder</h4>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-10 flex-col p-10">
        ...
        <div className="flex gap-2 items-center">
          ...
          <div className="flex flex-col gap-2">
            <h4 className="text-sm lg:text-md font-bold">Leonard Krasner</h4>
            <h4 className="text-sm lg:text-md">CEO & Founder</h4>
          </div>
        </div>
      </div>
